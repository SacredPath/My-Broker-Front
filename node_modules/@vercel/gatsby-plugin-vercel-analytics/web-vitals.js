...
function sendToAnalytics(metric, options) {
  ...
  const pageScript = [].slice.call(/^\/component---(.+)\-(.+?)\-.{20}\.js$/.exec(document.querySelector(`script[src^="/component---"]`)?.getAttribute("src")) ?? []).slice(1).join("-");
  ...
  const pageName = "component---" + pageScript in chunkMapping ? pageScript : null;
