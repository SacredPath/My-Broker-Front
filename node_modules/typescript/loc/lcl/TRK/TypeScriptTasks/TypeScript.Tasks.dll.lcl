    ...
    <Item ItemId=";Strings" ItemType="0" PsrId="211" Leaf="false">
      ...
      <Item ItemId=";CompilerLogNotSpecified" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Derleyici günlügü belirtilmedi. 'Temizle' komutu çalismaz.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";ConfigFileFoundOnDisk" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Bu proje, IntelliSense tarafindan düzgün sekilde kullanilamayan derleme için en az bir tsconfig.json dosyasi kullaniyor. Düzenleyici tarafindan düzgün sekilde kullanildiklarindan emin olmak için her tsconfig.json dosyasinin öge türünü TypeScriptCompile veya Content olarak ayarlayin.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";ErrorWritingLog" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Derleyici günlügü '{0}' ögesine yazilamadi. Özel durum: '{1}']]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";FallbackVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Derleyici sürümü ({0}) kullaniliyor. Bu yanlissa proje dosyanizdaki <TypeScriptToolsVersion> ögesini degistirin.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";LocatedReferenceFilesAt_0" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Basvuru dosyasinin bulundugu konum: '{0}'.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";NoCompilerError" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Proje dosyaniz, bu makinede yüklü olandan farkli bir TypeScript derleyicisi ve farkli araçlar kullaniyor. {0} konumunda derleyici bulunamadi. Bu sorunu, proje dosyanizda <TypeScriptToolsVersion> ögesini degistirerek düzeltebilirsiniz.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";NodeNotFound" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Derleme görevi, TypeScript derleyicisinin çalistirilmasi için gerekli olan node.exe dosyasini bulamadi. Lütfen Node'u yükleyin ve sistem yolunun Node konumunu içerdiginden emin olun.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";ToolsVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Proje dosyasinda belirtilen derleyici sürümü ({0}) bulunamadi.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";TypeScriptCompileBlockedSet" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[TypeScriptCompileBlocked özelligi 'true' olarak ayarlandigindan TypeScript derlemesi atlandi.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";TypeScriptNoVersionWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Projeniz bir TypeScriptToolsVersion belirtmiyor. Kullanilabilir son TypeScript derleyicisi ({0}) kullanilacak. Bu uyariyi kaldirmak için, TypeScriptToolsVersion degerini belirli bir sürüme ayarlayin veya en son derleyiciyi seçmek için "Latest" degerine ayarlayin.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";TypeScriptVersionMismatchWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Projenizde TypeScriptToolsVersion {0} olarak belirtiliyor, ancak bununla eslesen bir derleyici bulunamadi. Kullanilabilir son TypeScript derleyicisi ({1}) kullanilacak. Bu uyariyi kaldirmak için, TypeScript {0} SDK'sini yükleyin veya TypeScriptToolsVersion degerini güncellestirin.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
  ...
  <Item ItemId=";Version" ItemType="0" PsrId="211" Leaf="false">
    ...
    <Item ItemId=";FileDescription" ItemType="0" PsrId="211" Leaf="true">
      <Str Cat="Text">
        ...
        <Tgt Cat="Text" Stat="Loc" Orig="New">
          <Val><![CDATA[TypeScript Yapi Görevleri]]></Val>
        </Tgt>
      </Str>
      <Disp Icon="Str" />
    </Item>
