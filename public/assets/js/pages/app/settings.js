          ...
          <form id="payout-method-form">
            <div class="form-group">
              ...
              <select class="form-input form-select" id="method-type" ${isEdit ? 'disabled' : ''}>
                <option value="bank" ${method?.method_type === 'bank' ? 'selected' : ''}>Bank Account</option>
                <option value="paypal" ${method?.method_type === 'paypal' ? 'selected' : ''}>PayPal</option>
                <option value="crypto" ${method?.method_type === 'crypto' ? 'selected' : ''}>Cryptocurrency</option>
              </select>
            </div>
            ...
            <div id="bank-fields" class="method-fields" style="${method?.method_type === 'bank' || !method ? '' : 'display: none;'}">
              <div class="form-group">
            ...
            <div id="crypto-fields" class="method-fields" style="${method?.method_type === 'crypto' ? '' : 'display: none;'}">
              <div class="form-group">
